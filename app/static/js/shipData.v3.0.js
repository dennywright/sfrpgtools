...
var shipExpansionBays = {
  ...
  "Corpse recycler": {
    ...
    description:
      "A corpse recycler allows a starship crew to render bodies into parts for necrografts (Starfinder Adventure Path #3: Splintered Worlds 42). In a process that takes 1 hour, a carcass fed into the recycler produces a number of necrograft UPBs equal to 10 × the CR of the creature from which the corpse originated. These UPBs can be used only to create necrografts.",
    minSize: 1,
    slots: 1,
    source: "ds",
  },
